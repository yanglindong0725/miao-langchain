  ...
  return (
    ...
    >
      <div className="space-y-8">
        {/* 理论说明 */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">📖 什么是 Chain？</h2>
          <div className="prose text-gray-700 space-y-3">
            <p>
              Chain（链）是 LangChain 的核心概念，它允许你将多个组件串联起来：
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>组合多个步骤</strong>：Prompt → Model → 输出解析器</li>
              <li><strong>管道式处理</strong>：使用 <code>pipe()</code> 或 <code>|</code> 操作符连接</li>
              <li><strong>数据流转</strong>：前一个组件的输出自动传递给下一个组件</li>
              <li><strong>可复用工作流</strong>：封装复杂逻辑为可重用的 Chain</li>
            </ul>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">🔄 Chain 执行流程</h3>
            ...
            extraContent={
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-sm text-green-800">
                  ...
                  <br />
                  ChatPromptTemplate（总结提示词） → ChatOpenAI（DeepSeek 模型） → 输出结果
                </p>
              </div>
            }
          />
        ...
        <section className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start">
              ...
              <span>使用 <code className="bg-white px-2 py-1 rounded">.pipe()</code> 方法串联组件</span>
            </li>
            <li className="flex items-start">
